...
function EditProfile() {
    ...
    const handleSave = async (e)=>{
        ...
        setError(false);
        try {
            const updateUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$clientApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateMe"])({
                username
            });
            setUser(updateUser);
            router.push("/profile");
