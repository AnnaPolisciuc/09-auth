...
const fetchNotesServer = async (params = {})=>{
    ...
    const cookieHeader = cookieStore.toString(); // получаем все куки
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["nextServer"].get('/notes', {
        headers: {
            Cookie: cookieHeader
        },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__56aeac2a._.js.map