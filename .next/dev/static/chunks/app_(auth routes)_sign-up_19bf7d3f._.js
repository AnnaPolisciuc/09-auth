...
function SignUp() {
    ...
    const setUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$authStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])({
        "SignUp.useAuthStore[setUser]": (state)=>state.setUser
    }["SignUp.useAuthStore[setUser]"]);
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$clientApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["register"])(email, password);
...
_s(SignUp, "mfXXJn+kAzmxhhuE4GHkhLiX4Vs=", false, function() {
    return [
