...
function SignIn() {
    ...
    const setUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$authStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])({
        "SignIn.useAuthStore[setUser]": (state)=>state.setUser
    }["SignIn.useAuthStore[setUser]"]);
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$clientApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])(email, password);
            setUser(user);
            router.refresh();
            router.push('/profile');
        } catch (error) {
...
_s(SignIn, "20M6iZ854c0AZP1bmkljhoypuBo=", false, function() {
    return [
